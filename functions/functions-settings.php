...
add_action( 'after_setup_theme', 'inside_theme_support');
...
function inside_wphead_cleanup () {
...
add_action('after_setup_theme', 'inside_wphead_cleanup');


/* 2.2 LOAG OG-TAGS
/––––––––––––––––––––––––*/
// loads open graph tags » http://ogp.me/
// use 'inside_load_ogtags(true)' to also display the og:image tag
function inside_ogtags() {
  echo '
...
function inside_get_cachebusted_css() {
